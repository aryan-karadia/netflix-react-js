                        ...
                        <div className=' max-w-[450px] h-[600px] mx-auto bg-black/75 text-white rounded-lg'>
                            <div className='max-w-[320px] mx-auto py-16'>
                                ...
                                <form onSubmit={handleSubmit} className='w-full flex flex-col py-4'>
                                    ...
                                    <button className='bg-red-600 px-6 py-3 my-6 rounded cursor-pointer text-white font-bold'>Sign In</button>
                                    <div className='flex justify-between items-center text-sm text-neutral-400'>
                                        <p><input className='mr-2' type="checkbox" />Remember Me</p>
                                        <p>Need Help?</p>
                                    </div>
                                    <p className='py-3'><span className='text-neutral-400'>Don't have an account? <a className='text-white' href="/Signup">Sign up!</a></span></p>
                                </form>
                            </div>
                        </div>
